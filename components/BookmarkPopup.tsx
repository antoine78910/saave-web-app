...
export default function BookmarkPopup({ bookmark, onClose }: BookmarkPopupProps) {
  return (
    ...
    >
      <div 
        className="bg-gray-900 rounded-lg border border-gray-700 shadow-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto" 
          ...
          <div className="p-6 border-b border-gray-700">
            ...
            <div className="flex flex-wrap gap-2">
              {bookmark.tags.map((tag, index) => (
                <span 
                  key={index} 
                  className="bg-green-600/20 text-green-400 px-3 py-1 rounded-full text-sm border border-green-600/30"
                >
                  {tag}
                </span>
              ))}
